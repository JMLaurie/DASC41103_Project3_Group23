...
- `code/`: Main notebook and scripts (`ML_proj3_code.ipynb`) for preprocessing, modeling, and evaluation
...
- The model features multiple convolutional and pooling layers for feature extraction, ReLU activations, dropout for overfitting control, and dense layers for binary classification.
